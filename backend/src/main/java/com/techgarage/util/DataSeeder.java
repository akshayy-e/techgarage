...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        User f1 = userRepository.save(User.builder().name("Emma Wilson").email("react.dev@techgarage.com")
                .password(passwordEncoder.encode("Freelancer@123")).role(Role.FREELANCER).phone("+1-90000-00003").enabled(true).build());
        User f2 = userRepository.save(User.builder().name("Carlos Mendez").email("java.dev@techgarage.com")
                .password(passwordEncoder.encode("Freelancer@123")).role(Role.FREELANCER).phone("+1-90000-00004").enabled(true).build());
        User f3 = userRepository.save(User.builder().name("Priya Nair").email("python.dev@techgarage.com")
                .password(passwordEncoder.encode("Freelancer@123")).role(Role.FREELANCER).phone("+91-90000-00005").enabled(true).build());
        User f4 = userRepository.save(User.builder().name("Jason Lee").email("devops.dev@techgarage.com")
                .password(passwordEncoder.encode("Freelancer@123")).role(Role.FREELANCER).phone("+1-90000-00006").enabled(true).build());
        User f5 = userRepository.save(User.builder().name("Sofia Rossi").email("fullstack.dev@techgarage.com")
                .password(passwordEncoder.encode("Freelancer@123")).role(Role.FREELANCER).phone("+39-90000-00007").enabled(true).build());
